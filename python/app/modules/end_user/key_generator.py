...
from ...utils.derive_stake import StakeAddressDeriver
...
class KeyGenerator:
    ...
    def generate_addresses(self, mnemonic: str, account_index: int = 0,
        ...
        # Generate payment addresses (BIP44 path: m/1852H/1815H/accountH/0/i)
        addresses = []
        for i in range(address_count):
            # Derive payment key
            payment_path = f"0/{i}"  # External chain, address index i
